                ...
                <section id="popular-courses" class="courses">
                    <div class="container" data-aos="fade-up">
                        ...
                        <div class="row" data-aos="zoom-in" data-aos-delay="100">
                            <div class="col-lg-3 col-md-4 d-flex align-items-stretch">
                                <div class="course-item">
                                    ...
                                    <div class="course-content">
                                        ...
                                        <h3><a href="Lectures.jsp">Website Design</a></h3>
                                        <p>
                            ...
                            <div class="col-lg-3 col-md-4 d-flex align-items-stretch">
                                <div class="course-item">
                                    ...
                                    <div class="course-content">
                                        ...
                                        <div class="bar">
                                            <a href="#"><span class="badge badge-secondary">Start Course</span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <!-- End Course Item-->
                            <div
                                class="col-lg-3 col-md-4 d-flex align-items-stretch mt-4 mt-md-0"
                                >
                                <div class="course-item">
                            ...
                            <div
                                class="col-lg-3 col-md-4 d-flex align-items-stretch mt-4 mt-lg-0"
                                >
                                <div class="course-item">
