    ...
    >
      ...
      <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="UserTable.html">
              <div
                class="
                  icon icon-shape icon-sm
                  shadow
              ...
              <span class="nav-link-text ms-1">User_Table</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="Subject_Table.html">
              <div
                class="
                  icon icon-shape icon-sm
                  shadow
              ...
              <span class="nav-link-text ms-1">Subject_Table</span>
            </a>
          </li>
          <li class="nav-item">
